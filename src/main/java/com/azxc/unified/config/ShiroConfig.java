...
import com.azxc.unified.common.shiro.UserAuthFilter;
import com.azxc.unified.common.shiro.remerber.RememberMeManager;
...
public class ShiroConfig {
  ...
  public ShiroFilterFactoryBean getShiroFilterFactoryBean(
    ...
    for (String exclude : excludes) {
      if (!StrUtil.isEmpty(exclude.trim())) {
   ...
   */
  @Bean
  public AuthRealm getRealm(EhCacheManager ehCacheManager, UserService userService) {
