...
public class EntityBeanUtil {
  ...
  private static String[] defaultFields =
      new String[]{"createdDate", "lastModifiedDate", "createdBy", "lastModifiedBy", "status"};
  ...
  public static Object[] getId(Object entity) {
    Field[] sFields = entity.getClass().getSuperclass().getDeclaredFields();
    Field[] ssFields = entity.getClass().getSuperclass().getSuperclass().getDeclaredFields();
    for (Field field : ArrayUtil.addAll(sFields, ssFields)) {
   ...
   */
  public static void copyProperties(Object source, Object target, String... fields) {
    // 合并两个数组
  ...
  private static void copyProperties(Object source, Object target, @Nullable Class<?> editable,
    ...
    Class<?> actualEditableSuper = actualEditable.getSuperclass();
    if (editable != null) {
    ...
    PropertyDescriptor[] targetPds = ArrayUtil
        .addAll(BeanUtils.getPropertyDescriptors(actualEditable),
            BeanUtils.getPropertyDescriptors(actualEditableSuper));
    List<String> ignoreList = null;
    if (fields != null) {
      ignoreList = Arrays.asList(fields);
    }
  ...
  public static void copyPropertiesIgnores(Object source, Object target,
    ...
    System.arraycopy(ignoreProperties, 0, jointIgnoreProperties, defaultFields.length,
