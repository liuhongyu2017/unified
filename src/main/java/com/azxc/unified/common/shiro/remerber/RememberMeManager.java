package com.azxc.unified.common.shiro.remerber;

import com.azxc.unified.common.shiro.AuthRealm;
...
public class RememberMeManager extends CookieRememberMeManager {
  ...
  protected byte[] serialize(PrincipalCollection principals) {
    ...
    SimplePrincipalCollection collection = new SimplePrincipalCollection(principal,
   ...
   * 重写“记住我”实体类【反序列化】数据
   *
   * @param serializedIdentity the previously serialized {@code PrincipalCollection} as a byte
   *                           array
   */
