...
<#assign body>
  <div class="layui-form admin-compile">
    <form action="${basePath}/system/main/editPwd">
      <div class="layui-form-item">
        <label class="layui-form-label">原来密码</label>
        <div class="layui-input-inline">
          <input class="layui-input" type="password" name="original" aria-label=""
                 placeholder="请输入原来密码">
        </div>
      </div>
      <div class="layui-form-item">
...
<@layout.default title='修改密码' style=style body=body script=script/>