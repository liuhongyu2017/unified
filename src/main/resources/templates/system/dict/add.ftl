...
<#assign body>
  ...
  <div class="layui-form admin-compile">
    <form action="${basePath}/system/dict/save">
      <div class="row">
          <#if dict??>
            <input type="hidden" name="id" value="${(dict.id?c)!''}"/>
          </#if>
        <div class="layui-col-sm6 layui-col-md6">
          <div class="layui-form-item">
            <label class="layui-form-label required">字典标识</label>
            <div class="layui-input-inline">
              <input class="layui-input" type="text" name="name" placeholder="请输入字典键名"
                     aria-label="" value="${(dict.name)!''}">
            </div>
          </div>
        </div>
        <div class="layui-col-sm6 layui-col-md6">
            ...
            <div class="layui-input-inline">
              <select name="type" aria-label="">
                  <#list dictType?keys as key>
                    <option value="${key}"
                            <#if (dict.type?string == key)!false>selected</#if>>${dictType[key]}</option>
                  </#list>
              </select>
            </div>
          </div>
        ...
        <div class="layui-col-sm12 layui-col-md12">
          <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
              <input id="dictValue" name="value" type="hidden" value="${(dict.value)!''}">
        ...
        <div class="layui-col-sm12 layui-col-md12">
          ...
          <textarea class="layui-textarea" name="remark"
                    aria-label="" placeholder="请输入内容">${(dict.remark)!''}</textarea>
            </div>
          </div>
        </div>
      </div>
